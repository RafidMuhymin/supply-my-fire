import BackgroundImage from "@/assets/images/hero-bg-location.png";
...
const data = {
  ...
  certifications: [
    "Cardiff's Fireplace Specialists",
    "HETAS Approved",
    "Gas Safe Certified",
  ],
  servingText:
    "Serving Whitchurch, Llanishen, Heath, Roath, Pontcanna, Penarth & all Cardiff areas",
};
